...
if selected == "Home":
    ...
    with tab_risk:
        ...
        with col2:
            ...
            fig_country_risk = px.bar(
                ...
                y="risk_rate",
                color="risk_rate",
                title="High Risk Rate by Country (%)",
                color_continuous_scale="Reds"
            )
        
            fig_country_risk.update_layout(
                height=420,
                showlegend=False,
                margin=dict(
                    l=0,
    ...
    with col3:
        ...
        fig_type_risk = px.bar(
            ...
            y="risk_rate",
            color="risk_rate",
            title="High Risk Rate by Customer Type (%)",
    ...
    **{highest_risk_type['customer_type']}**
    ...
    2. Risk Intelligence Summary
    
    3. Customer Intelligence Summary
    
    4. Revenue Intelligence Summary
